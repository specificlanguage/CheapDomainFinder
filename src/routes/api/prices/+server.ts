...
import { queryGoDaddy, queryHover, queryNamecheap, queryNameSilo } from "$lib/server/domainPriceCheck.js";
...
export async function GET({ request }: RequestEvent) {
    ...
    const queries = [queryGoDaddy(domain), queryNameSilo(domain), queryNamecheap(domain), queryHover(domain)]
